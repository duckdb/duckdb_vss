...
private:
	...
	struct lookup_key_hash_t {
		...
		std::size_t operator()(vector_key_t const &k) const noexcept {
			return std::hash<vector_key_t> {}(k);
		}
	};
...
public:
	...
	member_citerator_t begin() const {
		return typed_->begin();
	}
	member_citerator_t end() const {
		return typed_->end();
	}
...
private:
	...
	static casts_t make_casts_(scalar_kind_t scalar_kind) {
		...
		case scalar_kind_t::f64_k:
			return make_casts_<f64_t>();
		case scalar_kind_t::f32_k:
			return make_casts_<f32_t>();
		case scalar_kind_t::f16_k:
			return make_casts_<f16_t>();
		case scalar_kind_t::i8_k:
			return make_casts_<i8_t>();
		case scalar_kind_t::b1x8_k:
			return make_casts_<b1x8_t>();
		default:
			return {};
		}
	}
